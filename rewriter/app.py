...
project_id = os.getenv("GCP_PROJECT_ID", "tsyp-477814")
database_id = os.getenv("FIRESTORE_DATABASE_ID", "tsypstore")
...
GCS_BUCKET_NAME = os.getenv("GCS_BUCKET_NAME", "tsypbucket")
